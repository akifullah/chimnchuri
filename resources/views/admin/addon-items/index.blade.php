        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-1">
                    <h4 class="card-title flex-grow-1">All Addon Items List</h4>

                    <a href="{{ route('admin.addon-items.create') }}" class="btn btn-sm btn-primary">
                        Add Item
                    </a>
                </div>
                <div>
                            ...
                            <tbody>
                                @forelse ($addonItems as $addonItem)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#!" class="text-dark fw-medium fs-15">{{ $addonItem->name }}</a>
                                        </td>
                                        <td>
                                            £ {{ number_format($addonItem->price, 2) }}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                ...
                                                <form action="{{ route('admin.addon-items.destroy', $addonItem->id) }}"
                                                    method="POST"
